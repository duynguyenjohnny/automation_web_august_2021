...
import aspire.controllers.BaseController;
import aspire.controllers.UserController;
import aspire.utilities.*;
    ...
    public void initializeDriver(@Optional("chrome") String browser,
        ...
        try {
            ...
            SecuredProperties.encryptNonEncryptedValues(config,
                    new File("./src/aspire/tests/registersuite/Register.properties"), // The Property File
                    "Website_Enviroment_URL"); // the property-key from "myConfiguration.properties"

            // read encrypted values from the property-file
            String Website_Enviroment_URL = SecuredProperties.getSecretValue(config,
                    new File("./src/aspire/tests/registersuite/Register.properties"), // The Property File
                    "Website_Enviroment_URL"); // the property-key from "myConfiguration.properties"

            String URL = Website_Enviroment_URL;
            try {
    ...
    public OS getOs() {
        ...
        public void afterTest(ITestResult iTestResult, Method method) {
            ...
            if (!iTestResult.isSuccess()) {
                ...
                test.log(LogStatus.FAIL, "Your Test was failed");
            } else {
                System.setProperty("org.uncommons.reportng.escape-output", "false");
